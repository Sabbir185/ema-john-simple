...
function Login() {
  ...
  return (
    <div className='App'>
      {
        user.isUserSignIn ? <button className='btn btn-warning  mb-5 mt-5' onClick={handleSignOut}>Sign Out</button> :
        <button className='btn btn-primary mt-5' onClick={handleSignIn}>Sign in with gmail</button>
      }
      <button className='btn btn-success mt-5 ml-3' onClick={handleFbSignIn}>FB Sign In</button>
      {
